            ...
            <div class="container">
                <div class="card" v-for="matic in starSeed" v-bind:class="{'larger':matic.type}">
                    <div v-if="!matic.type">
                        ...
                        <div class="grid">
                            <div class="label colored">
                                TOTAL TOKENS STAKED: {{matic.stakedBalance}}
                            </div>
                        </div>
        ...
        return {
            starSeed: [{
                ...
                },
                {
                    ...
                    img: logoMain,
                    show: false,
                    address:"0xc6e2e8395a671ee3f6f55177f8fe5984d5da7741",
