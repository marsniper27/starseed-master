            ...
            <div class="container">
                <div class="card"  v-for="matic in starSeed" v-bind:class="{'larger':matic.type}">
                    <div v-if="!matic.type">
                        ...
                        <input v-if="connected" v-model="matic.amount" />
...
export default {
    ...
    methods: {
        ...
        async StakeLP(itm){
            ...
            try{
                lpContractInstance.methods.approve(this.masterChefContractAddress,itm.amount).send({from: this.account}).then(
                    (receipt) => {
                        console.log(receipt);
                    })
            }catch(error){
                ...
                this.masterChefContractInstance.methods.deposit(itm.pid,itm.amount).send({from: this.account}).then(
                    (receipt) => {
                        console.log(receipt);
                    })
            }catch(error){
