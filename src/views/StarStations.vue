<template>
    <main id="main">
        <div class="content">
            <h4 class="heading center">Star Stations Control</h4>
            <div class="cards">
                <div class="container">
                    <div class="grid" style="width:85%; align-items: center; ">
                        <div class="card" style="min-width:80%; margin-left: 10%; align-items: center;">
                            <div class="grid">
                                <div class="label" style="margin-right: 10px;align-items: center;">
                                    Star in Wallet :
                                </div>
                            ...
                            <div class="grid" style="align-items: center; ">
                                <div>
                                    <div>Cost: 2 Star</div>
                                    <button @click="mintStation(0)">Mint Baby Class</button>
                                </div>
                                <div>
                                    <div>Cost: 11 Star</div>
                                    <button @click="mintStation(1)">Mint Meteor Class</button>
                                </div>
                                <div>
                                    <div>Cost: 33 Star</div>
                                    <button @click="mintStation(2)">Mint City Class</button>
                                </div>
                                <div>
                                    <div>Cost: 120 Star</div>
                                    <button @click="mintStation(3)">Mint Planet Class</button>
                                </div>
                            </div>
                            <button v-if="!connected" @click="matics()">Unlock Wallet</button>
                        </div>
                        <div class="container">
                            <div class="sm-heading center">
                                    NFT in Wallet :
                            </div>
                            <div class="card" v-for="station in starStations" v-bind:class="{'larger':matic.type}">
    ...
    export default {
        ...
        data() {
            return {
                ...
                starContractAddress : "0x7Ba798157147e37Dc4c54bDFa2aF013BAf3C02c2",
                starContractInstance:null,
                controllerContractAbi : [{"inputs": [{"components": [{"internalType": "uint256","name": "startingWeight","type": "uint256"},{"internalType": "uint256","name": "upgradeRate","type": "uint256"},{"internalType": "uint256","name": "price","type": "uint256"},{"internalType": "uint256","name": "maxUpgrade","type": "uint256"}],"internalType": "struct StarStation_Control.StationClass","name": "_station","type": "tuple"}],"name": "addClass","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_classPID","type": "uint256"},{"internalType": "string","name": "_uri","type": "string"}],"name": "mintNFT","outputs": [{"internalType": "uint256","name": "","type": "uint256"}],"stateMutability": "nonpayable","type": "function"},{"inputs": [],"name": "renounceOwnership","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_emissionRate","type": "uint256"},{"internalType": "address","name": "_stationAddress","type": "address"}],"stateMutability": "nonpayable","type": "constructor"},{"anonymous": false,"inputs": [{"indexed": true,"internalType": "address","name": "previousOwner","type": "address"},{"indexed": true,"internalType": "address","name": "newOwner","type": "address"}],"name": "OwnershipTransferred","type": "event"},{"inputs": [{"internalType": "uint256","name": "_increase","type": "uint256"}],"name": "setMaxIncrease","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "address","name": "_newOwner","type": "address"}],"name": "setStationOwner","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "address","name": "newOwner","type": "address"}],"name": "transferOwnership","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_classPid","type": "uint256"},{"internalType": "uint256","name": "_price","type": "uint256"}],"name": "updateClassPrice","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_classPid","type": "uint256"},{"internalType": "uint256","name": "_upgradeRate","type": "uint256"}],"name": "updateClassUpgrade","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_classPid","type": "uint256"},{"internalType": "uint256","name": "_startingWeight","type": "uint256"}],"name": "updateClassWeight","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_rate","type": "uint256"}],"name": "updateEmission","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "tokenId","type": "uint256"},{"internalType": "uint256","name": "increase","type": "uint256"}],"name": "updateNftWeight","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [{"internalType": "uint256","name": "_startId","type": "uint256"},{"internalType": "uint256","name": "_endId","type": "uint256"}],"name": "updateWeight","outputs": [],"stateMutability": "nonpayable","type": "function"},{"inputs": [],"name": "getEmission","outputs": [{"internalType": "uint256","name": "","type": "uint256"}],"stateMutability": "view","type": "function"},{"inputs": [],"name": "getStations","outputs": [{"components": [{"internalType": "uint256","name": "tokenId","type": "uint256"},{"internalType": "uint256","name": "class","type": "uint256"},{"internalType": "uint256","name": "weight","type": "uint256"},{"internalType": "uint256","name": "lastUpdate","type": "uint256"}],"internalType": "struct StarStation_Control.SpaceStations[]","name": "","type": "tuple[]"}],"stateMutability": "view","type": "function"},{"inputs": [],"name": "getWeight","outputs": [{"internalType": "uint256","name": "","type": "uint256"}],"stateMutability": "view","type": "function"},{"inputs": [],"name": "owner","outputs": [{"internalType": "address","name": "","type": "address"}],"stateMutability": "view","type": "function"}],
                controllerContractAddress : "0xe748079E0B03fed83273a9a70690506069c1e697",
                ...
                tokenContract:"0xEbF8F162A8EbB9Fe03BC94E6898B1d76843F8B22",
                image:null
            }
        },
        watch: {
        ...
        methods: {
            ...
            async getNFTMetadata() {
                const contract = new this.web3.eth.Contract(this.tokenURIABI, this.tokenContract)
                const numStations = await contract.methods.balanceOf("0x1f42Ad4C83ff23fD1a7bf5527FD74B731083cFaB").call()
                for(let x = 0; x < numStations;x++){
                    this.starStations.push(await contract.methods.tokenOfOwnerByIndex("0x1f42Ad4C83ff23fD1a7bf5527FD74B731083cFaB",x).call())
                }
                console.log(this.starStations)
                // const url = result.split("t/").pop();
                // console.log(url)
            ...
            async mintStation(stationClass){
                ...
                if(allowance < 122*10**18){
                    ...
                    try{
                        var receipt = await this.starContractInstance.methods.approve("0xe748079e0b03fed83273a9a70690506069c1e697",ethers.utils.parseUnits("100000",18))
                            .send({
                            ...
                            if(receipt){
                                await sleep(5000);
                                try{
                                    var result = await this.controllerContractInstance.methods.mintNFT(stationClass, "")
                                                    .send({
                                                        maxFeePerGas:(rates.fast.maxFee*(10**9)).toFixed(0),
                                                        maxPriorityFeePerGas:(rates.fast.maxPriorityFee*(10**9)).toFixed(0),
                                                        from:this.account
                                                    });
                                    var newStations = await this.controllerContractInstance.methods.getStations().call();
                                    if(newStations.length>totalStations.length){
                                        await this.postUri(newStations.length-1, stationClass);
                                    }
                                    return;
                                }catch(error){
            ...
            async postUri(tokenId,stationClass){
                const classInfo = classes.classes[stationClass];
                    ...
                    attributes : [
                        {
                            "display_type": "number", 
                            "trait_type": "Weight", 
                            "value": classInfo.startingWeight
                        },
                        {
                            "display_type": "boost_percentage", 
                            "trait_type": "Weight Increase", 
                            "value": 0
                        }, 
                    ]
                }
