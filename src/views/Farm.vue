            ...
            <div class="container">
                <div class="card" v-for="matic in starSeed" v-bind:class="{'larger':matic.type}">
                    <div v-if="!matic.type">
                        ...
                        <input v-if="connected" v-model="matic.amount" placeholder="Amount ot stake" />
...
export default {
    ...
    methods: {
        ...
        async getUserPoolStats(itm){
                ...
                itm.starEarned = (+itm.starEarned).toFixed(4);
        ...
        async harvest(itm){
            if(itm.starEarned > 0){
                try{
                    var receipt = await this.masterChefContractInstance.methods.harvestStar(itm.pid,this.account).call()
