...
export default {
    ...
    methods: {
        ...
        async emmission(){
            ...
            try{
                ...
                setTimeout(d=>{
                    ...
                    console.log("emission error: " + error);
            }
        },
        async allocation(){
        ...
        async getWBTCBalance(){
            var address = "0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6";
            ...
            try{
                ...
                console.log("dakota wbtc balance error: " + error);
            }
            ...
            try{
                ...
                console.log("dakota star - wbtc balance error: " + error);
            }
