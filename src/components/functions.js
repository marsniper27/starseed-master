...
//import starStats from "./starStats.js";
...
export async function getPendingStar(pid,web3,account){
    //masterChef.initMasterchef();
    //console.log("masterchef: "+masterChef.masterChefContractInstance);
...
async function getPoolInfo(itm,web3){
    ...
    try{
        ...
        itm.apr = (((((starStats.dailyEmission*(receipt.allocPoint/starStats.totalAllocation))*starStats.starPrice*365)/((receipt.totalLp/10**itm.decimals)*itm.price))*100).toFixed(4));
