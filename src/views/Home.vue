...
export default {
    ...
    data() {
        return {
            ...
            starContractAddress : "0x1fB241da53e3B550A3E70fc66fC79C40F0499445", 
            web3: null,
            contracts:{
                "WMatic":{
    ...
    methods: {
        async matics(){
            ...
            const myContractAddress = "0x1fB241da53e3B550A3E70fc66fC79C40F0499445"; 
        ...
        getStar(){
            location.href = "https://quickswap.exchange/#/swap?outputCurrency=0x1fB241da53e3B550A3E70fc66fC79C40F0499445";
        },
        async getPrice(){
            const request_body = {"erc20_address":"0x1fB241da53e3B550A3E70fc66fC79C40F0499445"};
